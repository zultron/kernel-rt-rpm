...
%changelog
* Wed Oct 03 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.44-1.el6.elrepo
- Updated to the 3.0.44 version source tarball.

* Sat Sep 15 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.43-1.el6.elrepo
- Updated to the 3.0.43 version source tarball.

* Mon Aug 27 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.42-1.el6.elrepo
- Updated to the 3.0.42 version source tarball.

* Thu Aug 16 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.41-1.el6.elrepo
- Updated to the 3.0.41 version source tarball.

* Thu Aug 09 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.40-1.el6.elrepo
- Updated to the 3.0.40 version source tarball.

* Thu Aug 02 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.39-1.el6.elrepo
- Updated to the 3.0.39 version source tarball.

* Fri Jul 20 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.38-1.el6.elrepo
- Updated to the 3.0.38 version source tarball.

* Mon Jul 16 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.37-1.el6.elrepo
- Updated to the 3.0.37 version source tarball.

* Fri Jun 22 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.36-1.el6.elrepo
- Updated to the 3.0.36 version source tarball.

* Mon Jun 18 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.35-1.el6.elrepo
- Updated to the 3.0.35 version source tarball.

* Sun Jun 10 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.34-1.el6.elrepo
- Updated to the 3.0.34 version source tarball.

* Mon Jun 04 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.33-1.el6.elrepo
- Updated to the 3.0.33 version source tarball.

* Fri May 25 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.32-3.el6.elrepo
- Rebuilt with CEPH support enabled.

* Thu May 24 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.32-2.el6.elrepo
- Corrected the configuration files.

* Mon May 21 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.32-1.el6.elrepo
- Updated to the 3.0.32 version source tarball.

* Mon May 07 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.31-1.el6.elrepo
- Updated to the 3.0.31 version source tarball.

* Fri Apr 27 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.30-1.el6.elrepo
- Updated to the 3.0.30 version source tarball.
- Re-enabled the build of the perf packages.

* Mon Apr 23 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.29-1.el6.elrepo
- Updated to the 3.0.29 version source tarball.
- Disabled the build of the perf packages due to an undetermined
- bug in the sources. With the 3.0.28 sources, the perf packages will
- build. With the 3.0.29 sources, the perf packages will not build.

* Fri Apr 13 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.28-1.el6.elrepo
- Updated to the 3.0.28 version source tarball.

* Wed Apr 04 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.27-1.el6.elrepo
- Updated to the 3.0.27 version source tarball.

* Sat Mar 24 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.26-1.el6.elrepo
- Updated to the 3.0.26 version source tarball.

* Tue Mar 20 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.25-1.el6.elrepo
- Updated to the 3.0.25 version source tarball.

* Tue Mar 13 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.24-1.el6.elrepo
- Updated to the 3.0.24 version source tarball.

* Thu Mar 01 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.23-1.el6.elrepo
- Updated to the 3.0.23 version source tarball.

* Tue Feb 21 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.22-1.el6.elrepo
- Updated to the 3.0.22 version source tarball.

* Tue Feb 14 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.21-1.el6.elrepo
- Updated to the 3.0.21 version source tarball.

* Mon Feb 06 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.20-1.el6.elrepo
- Updated to the 3.0.20 version source tarball.

* Fri Feb 03 2012 Alan Bartlett <ajb@elrepo.org> - 3.0.19-1.el6.elrepo
- Reverted to the 3.0.19 version source tarball.
